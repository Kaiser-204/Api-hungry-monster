const getSearchValue = () => {
    ...
    if (!searchValue) {
      ...
      .catch((error) => {
        document.getElementById("row").innerHTML="<h1>Incorrect! please try again.</h1>";
      });
    }
  };
      ...
      .then((data) => {
        ...
        meal.map((element) => {
          ...
          const foodDetailsDiv = `<div class="card p-4 w-75 shadow-lg rounded-3" > <img src="${foodImg}" alt="Food Card image>
              ...
              <h5>Ingredient</h5>
              <h6 class="card-text">  ${element.strIngredient1}</h6> <h6 class="card-text"> ${element.strIngredient6}</h6>
              <h6 class="card-text">  ${element.strIngredient2}</h6> <h6 class="card-text"> ${element.strIngredient7}</h6> 
              <h6 class="card-text">  ${element.strIngredient3}</h6> <h6 class="card-text"> ${element.strIngredient8}</h6>
              <h6 class="card-text">  ${element.strIngredient4}</h6> <h6 class="card-text"> ${element.strIngredient9}</h6>
              <h6 class="card-text">  ${element.strIngredient5}</h6> <h6 class="card-text"> ${element.strIngredient10}</h6>
  ...
  const backHome = () => {
    ...
    document.getElementById("searchFood").innerHTML = "";
    document.getElementById("row").innerHTML = "";
